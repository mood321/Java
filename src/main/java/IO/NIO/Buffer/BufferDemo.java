...
public class BufferDemo {
    public static void main(String[] args) {
        System.out.println("BufferDemo.main"+Runtime.getRuntime().freeMemory());

        //在堆上分配
      /*  ByteBuffer byteBuffer = ByteBuffer.allocate(1024000);
        System.out.println("byteBuffer"+byteBuffer);
        System.out.println("byteBuffer memory"+Runtime.getRuntime().freeMemory());
*/
        // 直接内存
      /*  ByteBuffer byteBuffer2 = ByteBuffer.allocateDirect(10240);
