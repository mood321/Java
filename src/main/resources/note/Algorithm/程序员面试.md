...
2、再看是否有|k-i|==|recor[k]-j|,若有，也说明（i,j）不能放置皇后。
 ````
<p> 思路:递归,dp
<p><a href="/src/main/java/algorithm/Interview/practice04/P_5_1_IsDeformation.java"> code</a>
...
````
    ...
    　　str="A-1B--2C--D6E", 返回7。
````
<p><a href="/src/main/java/algorithm/Interview/practice04/P_5_2_numSum.java"> code</a>
...
````
<p><a href="/src/main/java/algorithm/Interview/practice04/P_5_3_RemoveKZeros.java"> code</a>
