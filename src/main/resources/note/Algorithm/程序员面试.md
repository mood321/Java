...
<p> 思路3: Morris遍历 之后再补
<p><a href="/src/main/java/algorithm/Interview/practice02/P_3_0_PrintOrderRecur.java"> code</a>
...
<p> 思路1: 标准2 的思路 ,  1 只有一个孩子的 直接打印  2 有左右的 判断是有左右孩子  只有一个打印 3  叶子打印
 <p><a href="/src/main/java/algorithm/Interview/practice02/P_3_1_PrintEdge.java"> code</a>
   
 <p>3 如何直观的打印二叉树
 <p> 先序 中序 后序打印并不直观 
 <p>思路1: 高度,标识左子还是右子
 <p><a href="/src/main/java/algorithm/Interview/practice02/P_3_2_PrintBinaryTree.java"> code</a>
